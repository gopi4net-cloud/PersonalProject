...
namespace ANGDDEAPI.Controllers
{
    ...
    public class BHClaimSearchController : ControllerBase
    {
        ...
        public BHClaimSearchController(IHttpContextAccessor httpContextAccessor, DOConfiguration objConfiguration, IMemoryCacheHelper memoryCacheHelper, BOCommon bOCommon, ICacheService cache)
        {
        ...
        public IActionResult RxGetClaimDetails(string strClaimSearch)
        {
            ...
            DorxGetClaimDetailsRequest claimDetails = null;
            ...
            try
            {
                ...
                {
                    DOClaimInfo objDOClaimInfo = null;
                    claimDetails = new DorxGetClaimDetailsRequest();
                    objDOClaimInfo = JsonConvert.DeserializeObject<DOClaimInfo>(strClaimSearch);
        ...
        public IActionResult HemiGetClaimDetails(string strClaimSearch)
        {
            ...
            try
            {
                ...
                objCagmiInfo.sourceSystemInstance = "BOOK1";
