...
namespace ANGDDEAPI.Controllers
{
    ...
    public class HCPBHUNETAPIController : ControllerBase
    {
        ...
        public HCPBHUNETAPIController(IHttpContextAccessor httpContextAccessor, DOConfiguration objConfiguration, IMemoryCacheHelper memoryCacheHelper, BOCommon bOCommon, ICacheService cache)
        {
        ...
        public ActionResult GetClaimSummary(string strClaimSearch)
        {
            try
            {
                ...
                HCPBHUNETClaimMethods _objBOHCPUNETClaimSearch = new(_memoryCacheHelper,_cache, _objConfiguration);
