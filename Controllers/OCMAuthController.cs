...
namespace ANGDDEAPI.Controllers
{
    ...
    [ApiController]
    public class OCMAuthController : ControllerBase
    {
        ...
        public OCMAuthController(IHttpContextAccessor httpContextAccessor, DOConfiguration objConfiguration, IMemoryCacheHelper memoryCacheHelper, BOCommon bOCommon, ICacheService cache)
        {
        ...
        public async Task<ActionResult> Get(string strAuthSearch)
        {
            ...
            OCMAuthMethod objOCMAuthMethod = new(_memoryCacheHelper, _objConfiguration);
            try
            {
                ...
                if (!string.IsNullOrEmpty(strAuthSearch))
                {
                    ...
                    var (result, authInfoList) = await objOCMAuthMethod.GetOCMAuthHeader(objDOAuthInfo);
                    _result = result;
        ...
        public async Task<ActionResult> GetById(string id)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(id))
                {
                    ...
                    var (result, authInfoList) = await objOCMAuthMethod.GetOCMAuthDetails(objDOAuthInfo);
                    _result = result;
                    lstDOAuthInfo = authInfoList;
